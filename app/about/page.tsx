...
const timeline = [
  ...
  },
  {
    ...
    description:
      "Expanded into artificial intelligence and machine learning solutions.",
  },
  {
    year: "2020",
    title: "Global Expansion",
    description:
      "Opened offices in multiple countries and served 100+ clients.",
  },
  {
    year: "2022",
  ...
  },
  {
    ...
    description:
      "Pioneering next-generation solutions with 500+ successful projects.",
  },
];
...
const team = [
  {
    ...
    role: "CEO & Founder",
    avatar:
      "https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?w=200&h=200&fit=crop&crop=face",
  ...
  },
  {
    ...
    role: "CTO",
    avatar:
      "https://images.pexels.com/photos/733872/pexels-photo-733872.jpeg?w=200&h=200&fit=crop&crop=face",
  ...
  },
  {
    ...
    role: "Lead Designer",
    avatar:
      "https://images.pexels.com/photos/697509/pexels-photo-697509.jpeg?w=200&h=200&fit=crop&crop=face",
  ...
  },
  {
    ...
    avatar:
      "https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?w=200&h=200&fit=crop&crop=face",
          ...
          <div className="text-center">
            <FadeInView>
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                ...
                strategists who believe technology can transform businesses and
                improve lives.
              </p>
            </FadeInView>
          </div>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    ...
                    collaboration, creativity, and cutting-edge expertise.
                  </p>
                </div>
                    ...
                    <div className="text-center space-y-6">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          To be the global leader in innovative software
                          solutions, transforming industries through technology.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <CardContent className="p-6">
                    <div className="inline-flex p-4 rounded-full bg-brand-100 dark:bg-brand-900/20 mb-4">
                      {(() => {
                        ...
                        return <ValueIcon className="h-6 w-6 text-brand-600" />;
                      })()}
                    </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeInView className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Here's what we've accomplished together with our amazing clients
              and partners.
            </p>
          </FadeInView>
