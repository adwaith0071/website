...
const services = [
  {
    ...
    description: 'Full-stack web solutions that scale with your business. From responsive websites to complex web applications, we build fast, secure, and user-friendly digital experiences.',
    features: [
  ...
  },
  {
    ...
    description: 'Native iOS/Android and cross-platform mobile solutions that deliver exceptional user experiences. From concept to app store deployment, we handle the entire mobile development lifecycle.',
    features: [
  ...
  },
  {
    ...
    description: 'Custom AI solutions that drive intelligent automation and data-driven insights. From chatbots to predictive analytics, we implement cutting-edge AI technologies tailored to your business needs.',
    features: [
    ...
    technologies: {
      ...
      'Cloud AI': ['OpenAI GPT', 'AWS SageMaker', 'Google AI Platform', 'Azure ML']
    },
    gradient: 'from-green-500 to-teal-500',
    image: 'https://images.pexels.com/photos/8386440/pexels-photo-8386440.jpeg?w=600&h=400&fit=crop',
  },
  {
    id: 'data',
    icon: BarChart3,
    title: 'Data Science Solutions',
    description: 'Transform your data into actionable insights with advanced analytics, visualization, and data pipeline solutions. We help businesses make informed decisions through data-driven strategies.',
    features: [
    ...
    image: 'https://images.pexels.com/photos/590041/pexels-photo-590041.jpeg?w=600&h=400&fit=crop',
  },
];
...
const processSteps = [
  ...
  },
  {
    ...
    description: 'Our team designs scalable solutions with user-centric interfaces and robust technical architecture.',
  },
  {
    step: '03',
          ...
          <div className="text-center">
            <FadeInView>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                Services That <span className="gradient-text">Drive Innovation</span>
              </h1>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                We specialize in cutting-edge technologies to deliver exceptional solutions that transform businesses and drive growth.
              </p>
            </FadeInView>
          </div>
        </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeInView>
            ...
            <p className="text-xl text-white/90 mb-8 leading-relaxed">
              Let's discuss your requirements and explore how our expertise can bring your vision to life.
            </p>
