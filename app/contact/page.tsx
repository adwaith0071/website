...
const faqs = [
  {
    ...
    answer:
      "Project timelines vary based on complexity, but most web applications take 3-6 months, mobile apps 4-8 months, and AI/ML projects 6-12 months.",
  },
  {
    question: "Do you work with startups?",
    answer:
      "Absolutely! We love working with startups and have flexible engagement models to fit different budgets and requirements.",
  },
  {
    question: "What technologies do you specialize in?",
    answer:
      "We specialize in React, Node.js, Python, React Native, AI/ML frameworks, and modern cloud technologies like AWS and Azure.",
  },
  {
    question: "Do you provide ongoing support?",
    answer:
      "Yes, we offer various support and maintenance packages to ensure your application continues to perform optimally after launch.",
  },
];
          ...
          <div className="text-center">
            <FadeInView>
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                ...
                about your project and explore how we can help you succeed.
              </p>
            </FadeInView>
          </div>
        </div>
                  ...
                  <CardContent className="p-6 text-center">
                    <div className="inline-flex p-3 rounded-lg bg-brand-100 dark:bg-brand-900/20 mb-4">
                      {(() => {
                        ...
                        return <InfoIcon className="h-6 w-6 text-brand-600" />;
                      })()}
                    </div>
